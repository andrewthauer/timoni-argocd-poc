...
A [timoni.sh](http://timoni.sh) module for deploying generic-app to Kubernetes clusters.
...
```shell
timoni -n default apply generic-app oci://<container-registry-url>
```
...
```shell
timoni -n default delete generic-app
```
